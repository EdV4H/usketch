...
async function testUnifiedShape() {
	...
	try {
		...
		await execAsync("cd packages/shape-abstraction && pnpm build");
		...
		await execAsync("cd packages/shape-registry && pnpm build");
		...
		await execAsync("cd apps/whiteboard && pnpm build");
