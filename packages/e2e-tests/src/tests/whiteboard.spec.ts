...
export const whiteboardTests = () => {
  ...
  test('should draw a rectangle', async ({ page }) => {
    ...
    const rectangles = await page.locator('[data-shape="true"][data-shape-type="rectangle"]').count();
  ...
  test.skip('should handle keyboard shortcuts', async ({ page }) => {
    ...
    const remainingShapes = await page.locator('[data-shape="true"][data-shape-type="rectangle"]').count();
