import type { Shape, Camera } from '@whiteboard/shared-types';
import { getCanvasMousePosition, screenToWorld, applyCameraTransform, applyShapeTransform } from '@whiteboard/shared-utils';
