 ...
 *
 * This module defines types for layer management and grouping functionality.
 * Layers allow organizing shapes in a hierarchy with visibility, locking, and z-order control.
 */
