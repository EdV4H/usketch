...
- ec65083: カード手札を headless 化：host が独自の手札 UI を作れるように（#915）
...
- 2319e60: 手札(Hand)を独自の下部固定トレイから Control HUD の「Hand」パネルへ移行
...
- f4fd9d5: カードの出現演出（placement アニメ）を「手札から場に出したとき」だけに限定
