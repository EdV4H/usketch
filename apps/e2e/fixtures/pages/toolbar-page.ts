...
export class ToolbarPage {
	...
	async setStrokeWidth(width: number) {
		const strokeInput = this.page.locator(
			'input[type="range"][data-stroke], input[type="number"][data-stroke]',
		);
	 ...
	 */
	async toggleFill() {
		const fillToggle = this.page.locator(
			'input[type="checkbox"][data-fill], [data-testid="fill-toggle"]',
		);
