...
- Add a **drawing tool** so users can draw diamonds on the canvas — see [Building a Shape Plugin](/usketch/guides/shape-plugin/).
- Learn about the full [Plugin Architecture](/usketch/concepts/plugin-architecture/).
