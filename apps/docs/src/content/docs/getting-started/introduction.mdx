...
- [Quick Start](/docs/getting-started/quick-start/) — build a minimal plugin in 5 minutes.
- [Dev Setup](/docs/getting-started/dev-setup/) — clone the monorepo and run locally.
